...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper className="flex items-center justify-between gap-24 h-[calc(90vh-7rem)] lg:h-[calc(100vh-6rem)]">
        <div className="flex flex-col items-center text-center lg:text-left lg:items-start gap-1">
          ...
          <p className="mt-5 max-w-4xl text-primary/90 sm:text-lg">
          ...
          <ArrowButton text="Ver serviços" url="#services" />
        </div>
